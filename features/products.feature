...
Scenario: Update a product 
    ...
    Then I should see the message "Success"
    And I should see "Full bed sheets" in the "Description" field 
    When I change "Name" to "NEW_Sheets"
    ...
    And I press the "Retrieve" button
    Then I should see the message "Success"
    And I should see "NEW_Sheets" in the "Name" field
    When I press the "Clear" button
    And I press the "Search" button
    Then I should see the message "Success"
    And I should see "NEW_Sheets" in the results
...
Scenario: Search by available
    When I visit the "Home Page"
    And I press the "Clear" button
    And I select "True" in the "Available" dropdown And I press the "Search" button
    Then I should see the message "Success"
    And I should see "Hat" in the results
    And I should see "Big Mac" in the results
    And I should see "Sheets" in the results
